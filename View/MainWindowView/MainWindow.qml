                        ...
                        SplitView {
                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    anchors.fill: parent
                                    spacing: 0
                                    // Фиксированная область для "Master" и timeRuler
                                    RowLayout {
                                        Layout.fillWidth: true
                                        Layout.preferredHeight: 50
                                        spacing: 0

                                        // Фиксированный Rectangle с "Master"
                                        Rectangle {
                                            width: 150
                                            height: 50
                                            color: "#2D2D2D"
                                        ...
                                        // Прокручиваемая область для timeRuler
                                        Flickable {
                                            id: headerFlickable
                                            Layout.fillWidth: true
                                            Layout.preferredHeight: 50
                                            contentWidth: flickableArea.countOfBeats * flickableArea.beatWidth
                                            contentHeight: 50
                                            ...
                                            Binding {
                                                ...
                                                when: !headerFlickable.movingHorizontally
                                            }
                                            Binding {
                                    ...
                                    Flickable {
                                        ...
                                        Layout.fillWidth: true
                                        Layout.fillHeight: true
                                        contentHeight: contentGrid.height // Высота контента зависит от RowLayout
                                        contentWidth: rowLayout.width
                                        flickableDirection: Flickable.VerticalFlick // Только вертикальная прокрутка
                                        clip: true
                                        boundsMovement: Flickable.StopAtBounds
                                        maximumFlickVelocity: 1000 // Уменьшаем инерцию для более строгой прокрутки
                                        flickDeceleration: 2000 // Увеличиваем замедление
                                        ...
                                        onContentYChanged: {
                                            // Ограничиваем contentY в пределах [0, contentHeight - height]
                                            ...
                                            Flickable {
                                                ...
                                                // Треугольник в верхней части, направленный вниз
                                                    Canvas {
                                                        ...
                                                        width: 20
                                                        height: 10
                                                        x: greenline.x - 9 // Центрируем треугольник относительно greenline
                                                        y: flickableArea.contentY // Фиксируем в верхней части видимой области
                                                        z: 8
