...
id: pianoRoll
    ...
    property real clipDuration: viewModel.midiModel.clipDuration > 0 ? viewModel.midiModel.clipDuration : 4.0
    ...
    onTrackIndexChanged: {
        ...
        clipDuration = viewModel.midiModel.clipDuration > 0 ? viewModel.midiModel.clipDuration : 4.0
    }
    ...
    onClipDurationChanged: {
        ...
        // Обновляем contentWidth при изменении clipDuration
